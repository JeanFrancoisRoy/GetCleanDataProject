...
Features column are defined as the mean of the each group by activty and by subject. For more description on the feature plese refer to the features_info.txt of the UCI HAR Dataset
